...
- **多维评分** — 8 个维度加权评分：P/E、P/B、Graham Number、流动比率、D/E、盈利稳定性、分红、盈利增长
...
| `min_market_cap` | 5亿美元 | 过滤微型股 |
| `min_avg_volume` | 20万 | 确保流动性 |
| `pre_screen_pe_max` | 25 | P/E 粗筛上限（比 Graham 的 15 宽松） |
| `pre_screen_pb_max` | 3.0 | P/B 粗筛上限（比 Graham 的 1.5 宽松） |
